            ...
            <div class="col-md-12">
                    ...
                    {!! Form::open(['class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <select name="jenistanaman" id="jenistanaman" class="form-control">
                                <option value="">---------------</option>
                        ...
                        <div class="form-group">
                            <label for="keltanaman" class="col-md-1 control-label">Kelompok Taman</label>
                            <div class="col-md-3">
                                <select name="keltanaman" class="form-control">
                                    <option value="">------</option>
