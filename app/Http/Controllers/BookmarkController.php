...
class BookmarkController extends Controller {
	...
	public function createSuccess() {
		...
		return view('bookmark.createsuccess')->with('bookmark',$bookmark)->with('title', $title)->with('admin', $admin);
	}
	...
	public function editSuccess() {
		...
		return view('bookmark.editsuccess')->with('bookmark',$bookmark)->with('title', $title)->with('admin', $admin);
	}
