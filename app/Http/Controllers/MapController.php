...
class MapController extends Controller {
		...
		foreach ($identify as $key => $value) {
			...
			if (\Auth::user()) {
				if ($value['tablename']!=null) {
					$link = '<a href="'.$url.'/form-capture-{objectid}-'.$value['tablename'].'"><button class="btn"><i class="fa fa-camera"></i> Photo</button></a>';
				}
			}
	...
	public function formCaptureGet($objectid,$rth){
		return view('page.form.takephoto',compact('objectid','rth'));
	}
