define([
	...
	'dojo/text!./FindCoordinate/templates/Find.html',
	...
	'dijit/form/CheckBox',
	'xstyle/css!./FindCoordinate/css/Find.css'
	...
	return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
		...
		coordinate: function () {
        	...
        	XText = this.searchTextDijit.get('value');
        	YText = this.searchTextDijit2.get('value');
