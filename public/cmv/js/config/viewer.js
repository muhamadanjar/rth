define([
   ...
   'esri/layers/ImageParameters'
    ...
    var printbool = Boolean(printstatus);
    return {
        ...
        widgets: {
            ...
            geocoder: {
                ...
                options: {
                    ...
                    geocoderOptions: {
                        autoComplete: true,
                        arcgisGeocoder: {
                            placeholder: 'Masukan alamat atau tempat'
                        }
                    }
                }
            },
            ...
            print: {
                ...
                options: {
                    ...
                    printTaskURL: 'http://localhost:6080/arcgis/rest/services/SIMTARU/ExportWebMap/GPServer/Export%20Web%20Map',
            ...
            directions: {
                ...
                options: {
                    ...
                    options: {
                        ...
                        routeTaskUrl: 'http://192.168.20.15:6080/arcgis/rest/services/SIMTARU/ROUTE/NAServer/Route',
                        routeParams: {
