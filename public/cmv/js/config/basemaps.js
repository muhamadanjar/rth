define([
    ...
    return {
        ...
        mapStartBasemap: 'xstreets', // must match one of the basemap keys below
        ...
        basemapsToShow: ['streets','satellite', 'rupabumi','xstreets'],
        ...
        basemaps: { // agol basemaps
            ...
            xstreets: {
                ...
                basemap: new Basemap({
                    id: 'xstreets',
                    layers: [new BasemapLayer({
                        // url: 'http://localhost:6080/arcgis/rest/services/RuteAngkot/BasemapJalanKotaBogor/MapServer'
