  ...
  $(function(){
    ...
    $('#datatable1').dataTable({
        ...
        oLanguage: {
            ...
            sLengthMenu:  '_MENU_ dara dari halaman',
            info:         'Data Halaman _PAGE_ dari _PAGES_',
    ...
    var dtInstance2 = $('#datatable2').dataTable({
        ...
        oLanguage: {
            ...
            sLengthMenu:  '_MENU_ data / halaman',
            info:         'Data Halaman _PAGE_ dari _PAGES_',
...
(function($, window, document){
  ...
  $(function() {
    ...
    //$('#deskripsi').hide();
    $('#media-list').hide();
    if ($('#display-keyvalue').val() == "keyvalue") {
        $('#deskripsi').hide();
        $('#field-list').show();
    }else{
        $('#deskripsi').show();
...
(function($, window, document){
    window.chartHC = function (element,url) {
        // Properties
        this.element = $(element);
        this.url = url;
...
/*(function($, window, document){
    ...
    window.HCChart = function (element, url) {
      // Properties
      this.element = $(element);
      this.url = url;
    ...
    $(function() {
        ...
        $.getJSON("http://localhost/rth/public/report-rth-titik-grafikhc-kelurahan", function(json) {
          options.series = json;
